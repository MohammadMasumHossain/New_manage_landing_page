        ...
        <div className='flex justify-between'> 
            <div className='mt-40'>
                <div className='font-extrabold w-6/6 text-gray-700 text-4xl'>
                    <h1>Bring everyone <br></br> together to build <br></br>better products.</h1>
                </div>
                <div className='mt-10 text-gray-500 text'>
                    <p>Manage makes it simple for software teams <br></br> to plan day-to-day tasks while keeping the <br></br>larger team goals in view.</p>
                </div>
                <div className='mt-10 '>
